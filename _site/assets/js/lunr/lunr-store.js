var store = [{
        ...
        "title": "누적합",
        "excerpt":"알고리즘 문제를 풀다 종종 등장하는 누적합에 대해 알아보겠습니다. 누적합 누적합 알고리즘은 주어진 배열 또는 리스트의 원소들을 누적하여 합을 구하는 방식입니다. 이를 통해 부분 합을 빠르게 계산하고, 특정 구간의 합을 효율적으로 구할 수 있습니다. 누적합을 이해하기 위해 간단한 예제를 살펴보겠습니다. 주어진 배열 [1, 2, 3, 4, 5]의 누적합 계산 누적합 배열을...","categories": ["알고리즘하린"],
        "tags": [],
        ...
        "excerpt":"인공지능(AI)에서 지능(Intelligence)의 실체 인공지능에서 지능의 의미가 무엇일까. 지능은 알고있던 지식을 적용하는 방법이다. 그래서 지능의 실체는 지식이라고 할 수 있다. 지식은 어떤 사건 또는 사물의 인과 관계에 따른 기억에서 출발한다. 사물의 특성이나 사건 등의 흐름에 관한 관찰이나 경험이 하나의 기억으로 남게 되고, 여러 번의 경험을 통해 나온 기억에서, 어떤 사물 및...","categories": ["ETC"],
        "tags": [],
        "url": "/ETC/Intelligence/",
        "teaser": null
      },{
        "title": "대규모 뉴스 피드 시스템 설계",
        "excerpt":"뉴스 피드 시스템 설계 ‘가상 면접 사례로 배우는 대규모 시스템 설계 기초’라는 책을 토대로, 현실적인 예제를 통해 대규모 시스템을 어떻게 설계하는지 살펴보도록 하겠습니다. 이 글에서는 특히 우리가 흔히 사용하는 소셜 미디어 플랫폼에서 핵심적인 기능 중 하나인 ‘뉴스 피드(news feed)’ 시스템을 중심으로 다룰 것입니다. 페이스북, 인스타그램, 트위터와 같은 플랫폼에서는 뉴스 피드가...","categories": ["ETC"],
        "tags": [],
